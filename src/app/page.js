    ...
    <div className="flex justify-center items-center border-t bg-white p-8">
      <div className="w-full max-w-5xl overflow-hidden mx-auto items-center bg-white px-4 py-4 rounded shadow-xl">
        ...
        >
          ...
          >
            <h1 className="my-2 font-semibold">কলাউজান ইসলামী যুব কাফেলা</h1>
            <div className="text-left mb-6 block">
              নিচের ফরমে নাম, সদস্য নং, কত সাল থেকে কত সাল পর্যন্ত বকেয়া আছে
              পূূরণ করে সাবমিট করুন
            </div>
          ...
          {controlSubmit && (
            <div
              ref={receiptRef}
              className="grid lg:col-span-8 col-span-12 p-5 bgImg bg-[#ffffff] border-2 relative"
            >
              {/* Watermark */}
              <div className="absolute inset-0 flex justify-center items-center pointer-events-none">
                <span className="text-gray-300 hind text-5xl font-bold opacity-20 transform -rotate-45 whitespace-nowrap">
              ...
              <div className="relative z-10">
                ...
                <p>
                  ...
                  <span className="font-bold">যুব কাফেলার</span> বিগত সাধারণ
                  সভায় সবার সিদ্ধান্ত অনুসারে আগামী ফেব্রুওয়ারী ২৮ তারিখের মধ্যে
                  আপনার বকেয়া <span className="font-bold">{yearFrom}</span> সাল
                  থেকে <span className="font-bold">{yearTo}</span> সাল পর্যন্ত
                  সর্বমোট <span className="font-bold">{totalTaka}</span> টাকা
                  আদায় করিতে হইবে।
                </p>
